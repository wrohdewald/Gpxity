...
COPY dockeraccounts /usr/local/lib/python3.6/site-packages/gpxity/backends/test/test_accounts

# comment the next line if you want to run the tests manually

RUN cd /usr/local/lib/python3.6/site-packages/gpxity ; GPXITY_DISABLE_BACKENDS="MMT GPSIES Openrunner" pytest
